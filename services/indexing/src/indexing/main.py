"""
indexing — Qdrant vector indexing and PostgreSQL metadata persistence.
...
async def _startup() -> None:
    log.info("service.started", service="indexing", port=8003)
...
async def health() -> HealthModel:
    ...
    return HealthModel(service="indexing")
